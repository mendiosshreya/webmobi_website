...
function edit_save() {
    ...
    $.ajax({
        ...
        data: {
            "appid": des_app_edit,
            "Event_name": des_name_edit,
            "Category": des_cat_edit,
            "Sub_category": des_subcat_edit,
            "Format": des_format_edit,
            "URL": des_url_edit,
            "Description_text": des_descrip_text_edit,
            "Start_date": des_sdate_edit,
            "End_date": des_edate_edit,
            "Capacity": des_cap_edit,
            "Image_url": des_img_url_edit,
            "Free": des_free_edit,
            "Venue": des_venue_edit,
            "City": des_city_edit,
            "Country": des_country_edit,
            "Latitude": des_lat_edit,
            "Longitude": des_long_edit,
            "Email": des_email_edit,
            "Contact": des_contact_edit,
            "Organiser_name": des_oname_edit,
            "O_Website": des_oweb_edit,
            "O_Facebook_ID": des_ofb_edit,
            "O_Twitter_handle": des_otwitter_edit,
            "O_URL": des_ourl_edit,
            "O_Image_URL": des_oimgurl_edit,
            "O_Email": des_oemail_edit,
            "O_Contact": des_ocontact_edit,
            "created": des_created_edit,
            "changed": des_changed_edit,
            "active": des_active_edit,
            "status": des_status_edit,
            "aws-url": des_aws_url_edit,
            "source": des_source_edit,
            "o_source": des_osource_edit
        },
...
function add_save() {
    ...
    $.ajax({
        ...
        data: {
            "Event_name": des_name,
            "Category": des_cat,
            "Sub_category": des_subcat,
            "Format": des_format,
            "URL": des_url,
            "Description": des_descrip,
            "Description_text": des_descrip_text,
            "Start_date": des_sdate,
            "End_date": des_edate,
            "Capacity": des_cap,
            "Image_url": des_img_url,
            "Free": des_free,
            "Venue": des_venue,
            "City": des_city,
            "Country": des_country,
            ...
            "Email": des_email,
            "Contact": des_contact,
            "Organiser_name": des_oname,
            "O_Description": des_odesc,
            "O_Website": des_oweb,
            "O_Facebook_ID": des_ofb,
            "O_Twitter_handle": des_otwitter,
            "O_URL": des_ourl,
            "O_Image_URL": des_oimgurl,
            "O_Email": des_oemail,
            "O_Contact": des_ocontact
        },
